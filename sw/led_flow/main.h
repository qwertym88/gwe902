...
#define TIMER0_BASE (PERIPH_BASE + 0x0000UL)
#define UART0_BASE (PERIPH_BASE + 0x4000UL)
#define GPIOA_BASE (PERIPH_BASE + 0xC000UL)
#define GPIOB_BASE (PERIPH_BASE + 0xD000UL)
